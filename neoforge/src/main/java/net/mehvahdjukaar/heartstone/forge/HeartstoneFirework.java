...
public class HeartstoneFirework {
    ...
    public static void createParticles(FireworkParticles.Starter starter, boolean trail,
        ...
        createExactShape  (starter, 0.5, array, new IntArrayList(colors), new IntArrayList(fadeColors),
                trail, flicker, true);
    }


    private static void createExactShape(FireworkParticles.Starter starter,
                                         double speed, double[][] shape, IntList colours,  IntList fadeColours, boolean trail, boolean twinkle, boolean creeper) {
