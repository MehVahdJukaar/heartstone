...
//from alexmobs
public class CrowMoveController extends MoveControl {
    ...
    public CrowMoveController(Mob bird, float speedGeneral, boolean shouldLookAtTarget, boolean needsYSupport) {
        super(bird);
    ...
    public CrowMoveController(Mob bird, float speedGeneral, boolean shouldLookAtTarget) {
        this(bird, speedGeneral, shouldLookAtTarget, false);
    }

    public CrowMoveController(Mob bird, float speedGeneral) {
