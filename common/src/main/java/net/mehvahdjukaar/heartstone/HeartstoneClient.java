...
public class HeartstoneClient {
    ...
    public static void init() {
        ClientPlatformHelper.addBlockColorsRegistration(HeartstoneClient::registerBlockColors);
    ...
    private static void registerBlockColors(ClientPlatformHelper.BlockColorEvent event) {
        Heartstone.VERTICAL_SLABS.values().forEach(b -> event.register(new MimicBlockColor(), b));
    }
